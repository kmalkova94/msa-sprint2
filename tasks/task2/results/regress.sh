...
#echo "✅ Монолит доступен"

# Ждем booking-service
#timeout 60 bash -c 'until curl -s http://booking-service:9090/actuator/health > /dev/null; do sleep 1; done'
#echo "✅ Booking-service доступен"
